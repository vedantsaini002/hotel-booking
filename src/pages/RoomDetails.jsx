...
const RoomDetails = () => {
  ...
  useEffect(() => {
    ...
    console.log("Dummy IDs:", roomsDummyData.map((r) => r.id));

    const foundRoom = roomsDummyData.find((room) => String(room.id) === String(id));
  ...
  if (!room) {
    return (
      <div className="py-28 md:py-36 px-4 text-center text-xl text-gray-500">
        Hotel not found.
      </div>
    );
  }
